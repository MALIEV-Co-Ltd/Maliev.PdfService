...
public class SyncGenerationTests : IClassFixture<BaseIntegrationTestFactory<Program, PdfDbContext>>
{
    ...
    public SyncGenerationTests(BaseIntegrationTestFactory<Program, PdfDbContext> factory)
    {
        _factory = factory;
    }
